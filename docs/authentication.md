...
| Strategist | Просмотр, планирование, диагностические jobs |
| Editor | Просмотр, редактирование, диагностические jobs |
| Publisher | Просмотр, публикация уже одобренной редакции |
| Analyst | Просмотр, аналитика, диагностические jobs |
| Viewer | Только просмотр workspace |

Это permissions-контракт будущих модулей, а не утверждение, что публикация/редактор/админ-панель уже существуют. Сейчас есть read workspace и диагностический job. Одна роль на membership; deny-by-default. Расширение/совмещение ролей и право назначить Owner потребуют отдельного дизайна, migration и тестов. Повышенные роли без подтверждённого MFA не получают даже workspace read.
