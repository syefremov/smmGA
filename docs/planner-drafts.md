...
Это технические синтетические проверки, не оценка качества модели. Остаются реальные corpus/profile
evals, безопасное человеческое принятие предложения с provenance, генерация brief/ограничения
